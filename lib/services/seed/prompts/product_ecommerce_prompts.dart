    ...
    switch (subcategory) {
      ...
      case 'Fashion Apparel':
        return [
          ...
          {'title': 'Mens Suit Mannequin', 'platform': 'DALL-E 3', 'description': 'Formal suit on mannequin', 'text': 'Premium navy blue mens suit on mannequin, perfect tailoring visible, silk tie and pocket square, professional studio lighting, dark strategy background, menswear product photography'},
          ...
          {'title': 'Luxury Designer Handbag', 'platform': 'Stable Diffusion XL', 'description': 'Luxury bag product shot', 'text': 'Luxury designer handbag on pedestal, premium leather texture visible, gold hardware gleaming, elegant studio lighting, fashion accessories product photography'},
