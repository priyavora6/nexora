  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (_selectedImage != null || _webImage != null) {
        // Note: CloudinaryService needs to be updated to support bytes for Web
        // For now, this fixes the immediate crash.
        if (!kIsWeb) {
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: (kIsWeb && _webImage != null)
                        ? ClipRRect(borderRadius: BorderRadius.circular(16), child: Image.memory(_webImage!, fit: BoxFit.cover))
                        : (_selectedImage != null
